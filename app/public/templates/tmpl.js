...
var out='<div class="body-index"><div class="container"><div class="todo-description"><p>'+(it.todo)+'</p></div><a href="http://zhangjiayang.dev.p1staff.com:3200" class="delete-button"><p class="delete-button-text">DELETE</p></a></div></div>';return out;
};
  tmpl['footer']=function anonymous(it) {
var out='<section class="footer"></section>';return out;
};
  tmpl['header']=function anonymous(it) {
var out='<header class="landing-header"><section class="landing-header-container"><h1 class="title">YOUR TODOS</h1></section></header>';return out;
};
